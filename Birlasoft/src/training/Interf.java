 ...
 *   Each interface declares one method. Class Family implements 
 *   child .Instantiate Family and invoke each of its methods.

4. The Transport interface declares a deliver () method. The abstract class Animal is
